...
`define EXE_ADD_OP 8'b00000101
`define EXE_SUB_OP 8'b00000110
`define EXE_LUI_OP 8'b00000111
`define EXE_AUIPC_OP 8'b00001000
`define EXE_SLT_OP 8'b00001001
`define EXE_JAL_OP 8'b00001010
`define EXE_JALR_OP 8'b00001011
...
`define EXE_LH_OP 8'b00010001
`define EXE_LW_OP 8'b00010010
`define EXE_LBU_OP 8'b00010011
`define EXE_LHU_OP 8'b00010100
`define EXE_SB_OP 8'b00010101
`define EXE_SH_OP 8'b00010110
`define EXE_SW_OP 8'b00010111
`define EXE_SRL_OP 8'b00011000
`define EXE_SRA_OP 8'b00011001
`define EXE_SLTU_OP 8'b00011010
